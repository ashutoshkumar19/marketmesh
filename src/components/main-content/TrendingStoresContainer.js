...
function TrendingStoresContainer() {
  ...
  const handleScroll = string => {
    if (!content || !cardWidth) {
      content = document.getElementById('trending-stores-container');
  ...
  return (
    <Fragment>
      ...
      <div className='trending-stores-container slider-container' id='trending-stores-container'>
        <ProductCard
          images={[
      ...
      <div className='trending-stores-scroll-control slider-control control-left'>
        <i className='fas fa-chevron-left' onClick={() => handleScroll('left')}></i>
      </div>
      <div className='trending-stores-scroll-control slider-control control-right'>
